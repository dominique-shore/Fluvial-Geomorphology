...
This is an introductory course in fluvial geomorphlogly. Geomorphology is the study of landforms and processes that shape them. Fluvial geomorhpology is a sub-disicipline that focuses on *fluvial* processes (i.e. shaped by water) and landforms. We call the part of the landscape in which fluvial processes dominate, riverscapes. 
